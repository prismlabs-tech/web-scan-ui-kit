...
import './i18n/i18n.js';
import { findAndRenderPrismButton } from './ui/prism-button/prism-button.js';
import "./ui/theme/theme.css";
var Prism = {
    render: function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    version: process.env.PRISM_VERSION,
};
function initializeWidget(config) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log("Initializing Prism SDK");
            console.log("Prism SDK version ".concat(process.env.PRISM_VERSION, " with config: ").concat(JSON.stringify(config)));
