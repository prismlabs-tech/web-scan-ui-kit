...
export function PrismSessionView(_a) {
  var _this = this;
  var onSessionStateChange = _a.onSessionStateChange,
    onClose = _a.onClose;
  var t = useTranslation().t;
  var _b = useState(getIsPortraitMobile()),
    isPortraitMobile = _b[0],
    setIsPortraitMobile = _b[1];
  var _c = useState(false),
    isSessionInitialized = _c[0],
    setIsSessionInitialized = _c[1];
  var _d = useState(false),
    isVideoReady = _d[0],
    setIsVideoReady = _d[1];
  var _e = useState(null),
    hasCameraPermission = _e[0],
    setHasCameraPermission = _e[1];
  var _f = useState(),
    cameraError = _f[0],
    setCameraError = _f[1];
  var _g = useState(),
    scanBlob = _g[0],
    setScanBlob = _g[1];
  var _h = useState(PrismSessionState.IDLE),
    sessionState = _h[0],
    setSessionState = _h[1];
  var prismSession = useState(function () {
    var captureSession = new CaptureSession();
    return new PrismSession(captureSession);
  })[0];
  var _j = useState(false),
    cameraPermissionDenied = _j[0],
    setCameraPermissionDenied = _j[1];
  useEffect(
    function () {
  ...
  useEffect(function () {
    var handleResize = function () {
      return setIsPortraitMobile(getIsPortraitMobile());
    };
  ...
  useEffect(
    function () {
      var subscription = prismSession.currentSessionState.subscribe(
        function (state) {
      ...
      prismSession.captureSession.cameraManager.onPermissionChange = function (
        state
      ) {
      ...
      var recordingSubscription =
        prismSession.captureSession.recorder.recording$.subscribe(
          function (blob) {
            setScanBlob(blob);
          }
        );
  ...
  var handleVideoReady = function (video) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              prismSession.captureSession.cameraManager.startVideoPlayback(
                video
              ),
            ];
          case 1:
  ...
  return _jsx(Modal, {
    ...
    children: _jsxs(ModalContentContainer, {
      isMobile: isPortraitMobile,
      ...
      children: [
        ...
        cameraError
          ? _jsxs("div", {
              ...
              children: [
                _jsx("h1", { children: "Error accessing the camera feed" }),
                hasCameraPermission === false
                  ? _jsx("p", { children: "Please enable camera permissions" })
                  : _jsx("p", { children: cameraError.message }),
              ],
            })
          : _jsxs("div", {
              style: {
              ...
              children: [
                sessionState === PrismSessionState.LEVELING &&
                  _jsx(LevelScreen, { prismSession: prismSession }),
                sessionState === PrismSessionState.POSITIONING &&
                  _jsx(PositionScreen, { prismSession: prismSession }),
                sessionState === PrismSessionState.POSING &&
                  _jsx(PosingScreen, { prismSession: prismSession }),
                sessionState === PrismSessionState.RECORDING &&
                  _jsx(RecordingScreen, { prismSession: prismSession }),
                sessionState === PrismSessionState.PROCESSING &&
                  _jsx(ProcessingScreen, { onClose: endSession }),
                sessionState === PrismSessionState.FINISHED &&
                  _jsxs("div", {
                    children: [
                      _jsx("h3", { children: t("prism.finished.title") }),
                      _jsx("p", { children: t("prism.finished.description") }),
                      _jsx("button", {
                        onClick: endSession,
                        style: {
                          padding: "10px 20px",
